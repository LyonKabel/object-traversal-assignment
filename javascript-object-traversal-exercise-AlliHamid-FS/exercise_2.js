...
(() => {
    ...
    function stuff(){
      ...
      const moviesOnly = api.media.filter(media => media.Type === "movie");
      console.log("Only movies: ");
      console.log(moviesOnly);


      const breakingBrad = api.media.filter(media => media.Title === "Breaking Bad")
      console.log("Breaking bad: ");
      console.log(breakingBrad);

      const comingSoonMedia = api.media.filter(media => media.Released === 'N/A');
      console.log("Media Coming Soon:");
      console.log(comingSoonMedia);
