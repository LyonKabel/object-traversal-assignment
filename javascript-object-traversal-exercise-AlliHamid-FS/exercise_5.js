...
(() => {
    ...
    function pokemon(){
      ...
      const firstItemHeld = api.held_items[0];
      console.log("First item held: ");
      console.log(firstItemHeld);

      console.log(`${api.name} is a ${api.forms.type} with a weight of ${api.weight} and has ${api.hp} hp`)
